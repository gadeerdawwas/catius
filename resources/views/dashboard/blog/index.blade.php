                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title mb-0">مدونة </h4>
                            </div><!-- end card header -->
                            ...
                            <div class="card-body">
                                        ...
                                        <table class="table align-middle table-nowrap" id="customerTable">
                                            <thead class="table-light">
                                                <tr>
                                                    ...
                                                    <th class="sort" data-sort="action"> صور </th>
                                            ...
                                            <tbody class="list form-check-all">
                                                @foreach ($blogs as $blog)
                                                    <tr>
                                                        ...
                                                        <td class="name_ar">{{ $blog->title }}</td>
                                                        <td class="name_en">{{ $blog->content }}</td>
                                                        <td class="name_en">
                                                            ...
                                                            <div class="d-flex gap-2">
                                                                <div class="edit">
                                                                    <button class="btn btn-sm btn-success edit-item-btn"
                                                                        ...
                                                                        data-bs-target="#editModal{{ $blog->id }}">تعديل</button>
                                                                </div>

                                                                <div class="remove">
                                                                    <button class="btn btn-sm btn-danger remove-item-btn"
                                                                        data-bs-toggle="modal"
                                                                        data-bs-target="#deleteRecordModal{{ $blog->id }}">حذف</button>
                                                                </div>
                                                            </div>
                                                        </td>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3" id="modal-id">
                                        ...
                                        <input type="text" id="id-field" name="title" value="{{ $blog->title }}" class="form-control"
                                             required />
                                    </div>

                                    <div class="mb-3" id="modal-id">
                                        <label for="id-field" class="form-label">وصف الخدمة  </label>
                                        <textarea name="content" class="form-control" id="" cols="5" rows="5">{{ $blog->content }}</textarea>
                                        ...
                                        <button type="submit" class="btn btn-success" id="add-btn">
                                            إضافة</button>
                                                        ...
                                                        <div class="modal fade zoomIn"
                                                            id="deleteRecordModal{{ $blog->id }}" tabindex="-1"
                                                            aria-hidden="true">
                                                            <div class="modal-dialog modal-dialog-centered">
                                                                <div class="modal-content">
                        ...
                        <div class="modal-content">
                            ...
                            <form action="{{ route('admin.blogs.store') }}" method="POST"
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        <label for="place-field" class="form-label">صور  الخدمة</label>
                                        <input type="file" name="image" id="" required
                                        class="form-control">
